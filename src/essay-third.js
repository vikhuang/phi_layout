    ...
    return(
        <div className='essay4'>
            <div className='second_wrapper_right'> 
                <Essay3 onFocused={props.onFocused} />
            </div>
        <Editor essayNo='Essay Part5' onFocused={onFocusedBoolean}/>
      </div>
    );
}

export const Essay6 = (props) => {
    const onFocusedBoolean = (props.onFocused === 6);
    return(
        <div className='essay4'>
            <div className='second_wrapper_left'> 
                <Essay4 onFocused={props.onFocused} />
            </div>
        <Editor essayNo='Essay Part6' onFocused={onFocusedBoolean}/>
      </div>
    );
}
